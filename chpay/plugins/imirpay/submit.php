...
if($order['typename']=='alipay'){
	echo "<script>window.location.href='/pay/imirpay/alipay/{$trade_no}/?sitename={$sitename}';</script>";
}elseif($order['typename']=='wxpay'){
	echo "<script>window.location.href='/pay/imirpay/wxpay/{$trade_no}/?sitename={$sitename}';</script>";
}