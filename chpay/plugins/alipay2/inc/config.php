...
$config = array (
	...
	//异步通知地址
	'notify_url' => $conf['localurl'].'plugins/alipay/notify.php/'.(defined("TRADE_NO")?TRADE_NO:$order['trade_no']).'/',

	//同步通知地址
	'return_url' => $conf['localurl'].'plugins/alipay/return.php/'.(defined("TRADE_NO")?TRADE_NO:$order['trade_no']).'/',
