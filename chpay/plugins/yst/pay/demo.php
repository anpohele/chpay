...
class demo
{
    ...
    function demo()
    {
        ...
        $this->param = array();
        $this->param['businessgatecerpath'] = __DIR__."/certs/businessgate.cer";
        //$this->param['businessgatecerpath'] = 'http://' . $_SERVER['HTTP_HOST'] . "/plugins/PHP_Pay/pay/certs/businessgate.cer";

        $this->param['private_key'] = __DIR__."/certs/test.pfx";

        // $this->param['seller_id'] = 'APHL';
        // $this->param['seller_id'] = 'X2201201805261290011';
        $this->param['seller_id'] = 'X2201261516431291010';
        	


        // $this->param['seller_name'] = '安颇赫勒（上海）智能科技有限公司';
        $this->param['seller_name'] = '朱俊杰';
        //  $this->param['seller_name'] = '孙颢玮';
...
//        $this->param['order_url'] = 'https://mertest.ysepay.com/openapi_gateway/gateway.do';
        ...
        $this->param['wxpublic_url'] = 'https://qrcode.ysepay.com/gateway.do';
...
//        $this->param['ds_query_url'] = 'https://mertest.ysepay.com/openapidsf_gateway/gateway.do';
        ...
        $this->param['notify_url'] = 'http://jianye.dickmorley.cn/plugins/yst/notify.php';
        $this->param['return_url'] = 'http://api.test.ysepay.net/atinterface/receive_return.htm';
        $this->param['pfxpassword'] = 'mes12345';
