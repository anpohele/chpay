...
require_once SYSTEM_ROOT.'f2fpay/model/request/AlipaySystemOauthTokenRequest.php';
require_once SYSTEM_ROOT.'f2fpay/model/request/AlipayUserInfoShareRequest.php';
