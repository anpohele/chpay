...
//通用转账
//type alipay:支付宝,wxpay:微信,qqpay:QQ钱包
...
function update_version(){
	return array('code'=>0,'msg'=>'<font color="green">您使用的已是最新版本！</font><br/>当前版本：V8.1 (Build 3015)</font>','uplog'=>null,'file'=>null,'sql'=>null);
}
?>