...
<div id="main">
    <div id="head">
        <dl class="alipay_link">
            <a target="_blank" href="https://pay.fairydeed.com/"><span>免签约申请地址</span></a>
        </dl>
        <span class="title">支付免签约即时到账</span>
    </div>
        ...
        <div id="body" style="clear:left">
            <dl class="content">
                ...
                <dd>
                    ...
                    <label><input type="radio" name="type" value="unionpayh5">银联</label>&nbsp;
