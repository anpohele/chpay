				...
				<form class="form-horizontal" id="form-store">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							...
							</select><a tabindex="0" class="input-group-addon" role="button" data-toggle="popover" data-trigger="focus" title="通道模式说明" data-placement="bottom" data-content="【平台代收】资金由平台代收，然后结算给商户，手续费从每笔订单直接扣除 【商户直清】资金由上游直接结算给商户，手续费从商户余额扣除"><span class="glyphicon glyphicon-info-sign"></span></a></div>
						</div>
					</div>
					<div class="form-group">
...
function getAll(type, channel, obj){
	...
	$.ajax({
		type : 'GET',
		url : 'ajax.php?act=getChannelMoney&type='+type+'&channel='+channel,
		dataType : 'json',
		success : function(data) {
			layer.close(ii);
			if(data.code == 0){
