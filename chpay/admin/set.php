...
<div class="panel-body">
  ...
  <h4 style="text-align: center;">支付配置</h4>
	...
	<div class="form-group">
	  <label class="col-sm-3 control-label">缺省微信公众号通道</label>
	  <div class="col-sm-9"><select class="form-control" name="wxurl" default="<?php echo $conf['wxurl']?>"><option value="0">关闭</option><?php foreach($wxpay_channel as $channel){echo '<option value="'.$channel['id'].'">'.$channel['name'].'</option>';} ?></select><font color="green">部分银行服务商的支付插件要求使用自有的微信公众号，此处可以先添加支付插件为wxpay的支付通道，默认则使用此微信公众号，只需服务号不需要开通微信支付</font></div>
	</div><br/>
	<div class="form-group">
	...
	<div class="form-group">
	  ...
	  <div class="col-sm-9"><textarea class="form-control" name="blockusers" rows="2" placeholder="多个用|隔开，只支持微信公众号支付"><?php echo $conf['blockusers']?></textarea></div>
	</div><br/>
...
<div class="panel-body">
  <form onsubmit="return saveSetting(this)" method="post" class="form-horizontal" role="form">
	<div class="form-group">
	  ...
	  <div class="col-sm-10"><select class="form-control" name="proxy" default="<?php echo $is_proxy?>">
